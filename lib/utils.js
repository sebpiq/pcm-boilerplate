...
// This creates a readable stream, returning data encoded using a `BufferEncoder`.
// `format` is the same as for `BufferEncoder`.
// You can push a block to the stream by calling the method `pushBlock(block)`.
...
var StreamEncoder = module.exports.StreamEncoder = function(format, opts) {
  ...
  this._blocks = []
  this._maxBufferedBlocks = 10
  this._spaceAvail = true
}
inherits(StreamEncoder, Readable)

_.extend(StreamEncoder.prototype, Readable.prototype, {

  pushBlock: function(block) {
    this.push(this._encoder(block))
  },

  // This is required I don't really know why
  _read: function() {}
